...
function PolicyDetails() {
  ...
  const policyDetails = [
    ...
    { PolicyNum: "NUQ 66666", PolicyInfo: "You have a result here" },
    { PolicyNum: "NUQ 55555", PolicyInfo: "You have a result here" },
    { PolicyNum: "NUQ 11111", PolicyInfo: "You have a result here" },
    { PolicyNum: "NUQ 22222", PolicyInfo: "You have a result here" },
    { PolicyNum: "NUQ 33333", PolicyInfo: "You have a result here" },
    { PolicyNum: "NUQ 44444", PolicyInfo: "You have a result here" },
    ...
    <div className='mainDiv myBgFC mainDivPolDet'>
      <div>
        ...
        <input
          ...
          value={searchInput} />
        <Button block="true" size="lg" type="submit" id="button1" onClick={searchPolicy} disabled={!validateForm()}>
          <span>{element}</span>
        </Button>
